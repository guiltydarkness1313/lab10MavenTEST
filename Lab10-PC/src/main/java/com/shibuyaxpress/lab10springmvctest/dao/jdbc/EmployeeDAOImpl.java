package com.shibuyaxpress.lab10springmvctest.dao.jdbc;
...
import com.shibuyaxpress.lab10springmvctest.dao.EmployeeDAO;
...
import com.shibuyaxpress.lab10springmvctest.mapper.EmployeeMapper;
...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public List<Employee> findEmployeesByLastName(String lastname) throws DAOException, EmptyResultException {
		...
		String query ="select employee_id, login, password,first_name,last_name, salary ,departament_id FROM employees where upper(last_name)=(?)";
